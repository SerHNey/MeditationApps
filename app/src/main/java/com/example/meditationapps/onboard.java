...
public class onboard extends AppCompatActivity {
    ...
    public void AuthAct(View v){
        Intent intent = new Intent(onboard.this, activity_authorization.class);
            ...
            public void run() {
                try {
                    ...
                    if (HttpResult == HttpURLConnection.HTTP_OK) {
                        ...
                        Intent main = new Intent(onboard.this,MainActivity.class);
                        startActivity(main);
                    } else {
                        Toast.makeText(onboard.this, "invalid username or password", Toast.LENGTH_SHORT).show();
                    }
                }
                catch (Exception e){
                    Log.d("e",e.toString());
